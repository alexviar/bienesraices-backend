...
test('el usuario ha iniciado sesión', function () {
    ...
    $response = $this->getJson("/creditos/$credito->codigo/plan-pagos");
...
test('usuarios sin permiso no estan autorizados', function ($dataset) {
    ...
    $response = $this->actingAs($login)->get("/creditos/$credito->codigo/plan-pagos");
    ...
    "Proyecto no vinculado" => function(){
        ...
        /** @var Role $rol */
        $rol = Role::factory()->create();
        $rol->givePermissionTo("Imprimir plan de pagos");
        $login->assignRole($rol);
...
test('usuarios autorizados', function ($dataset) {
    ...
    $response = $this->actingAs($login)->getJson("/creditos/$credito->codigo/plan-pagos");
    ...
    "Acceso indirecto" => function(){
        ...
        $permission->givePermissionTo("Imprimir plan de pagos");
...
it("imprime el plan de pagos en pantalla", function(){
    ...
    $response = $this->actingAs($user)->get("/creditos/$credito->codigo/plan-pagos");
